program D8_roller_EnJnDeSIgn2024
	implicit none
	character(len=1) :: user_input
	integer :: selected_group, selected_number
	character(len=180), dimension(0:3, 0:1) :: groups
	character(len=180), dimension(2) :: group0, group1, group2, group3
	...
	print *, "D8_roller_EnJnDeSIgn2024_1-8"
...
print *, "from group ", selected_group, ": ", &
	...
	print *, "thank you for using the d8 roller."
end program D8_roller_EnJnDeSIgn2024