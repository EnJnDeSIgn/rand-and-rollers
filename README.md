...
New Die*.exe's out, Die10 works on mode as the other lower one do but it somtimes prints 2 most common digits so pick in between an 0 = 10 as there is a Die100.exe
