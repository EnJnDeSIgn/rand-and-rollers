program Die30_roller_EnJnDeSIgn2024
    ...
    do j = 1, num_iterations
        ...
        do i = 1, roll_count
            ...
            if (selected_numbers(i) == '0') then
                call random_number(rand)
                final_numbers(i) = int(rand * 15)  ! Values 0-49
            else if (selected_numbers(i) == '1') then
                call random_number(rand)
                final_numbers(i) = int(rand * 15) + 15  ! Values 50-99
            end if
	...
	print *, "Mode 0-29:"
		...
		d30_value = final_numbers(position_index)
		d30 = d30_value

		! Adjust d30 to be in the range 1-30
		d30 = mod(d30, 30) + 1

		print *, "Random D30: ", d30
end program Die30_roller_EnJnDeSIgn2024