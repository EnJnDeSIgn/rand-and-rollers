...
program Dt7
	...
	num14, num15, num16, num17, num18, num19, num20, num21, num22, num23, num24, num25, num26, num27, num28, num29
	...
	num21_str, num22_str, num23_str, num24_str, num25_str, num26_str, num27_str, num28_str, num29_str
	character(len=30) :: combined_str0, combined_str1, combined_str2, combined_str3, combined_str4, combined_str5, combined_str6, &
	combined_str7, combined_str8, combined_str9
