program Dt1_roller_EnJnDeSIgn2024
	...
	character(len=32), dimension(0:1142, 0:2) :: groups
 ...
 group1142 = (/ "   -48.6622390747070312500000000", "    68.7433242797851562500000000", "   -89.7780685424804687500000000" /)
	...
	selected_group = int(rand *1143) ! Warning, Ian Change THIS one last on this paticular program, it's in a different spot.
