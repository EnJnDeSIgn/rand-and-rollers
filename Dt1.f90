program Dt1_roller_EnJnDeSIgn2024
	...
	character(len=32), dimension(0:1205, 0:2) :: groups
 ...
 group1205 = (/ "   -16.3194332122802734375000000", "   -43.4547615051269531250000000", "   -40.0648193359375000000000000" /)
	...
	selected_group = int(rand *1206) ! Warning, Ian Change THIS one last on this paticular program, it's in a different spot.
