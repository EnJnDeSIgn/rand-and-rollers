program Dt1_roller_EnJnDeSIgn2024
	...
	character(len=32), dimension(0:1475, 0:2) :: groups
 ...
 group1475 = (/ "   -51.2537078857421875000000000", "   -19.1543827056884765625000000", "    25.6630630493164062500000000" /)
	...
	selected_group = int(rand *1476) ! Warning, Ian Change THIS one last on this paticular program, it's in a different spot.
