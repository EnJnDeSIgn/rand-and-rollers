program Dt1_roller_EnJnDeSIgn2024
	...
	character(len=32), dimension(0:1268, 0:2) :: groups
 ...
 group1268 = (/ "   -21.5745964050292968750000000", "    98.6765975952148437500000000", "   -33.8637771606445312500000000" /)
	...
	selected_group = int(rand *1269) ! Warning, Ian Change THIS one last on this paticular program, it's in a different spot.
