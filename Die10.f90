program Die10_roller_EnJnDeSIgn2024
	...
	print *, "Mode 0-9:"
		...
		d10_value = final_numbers(position_index)
		d10 = d10_value

		! Adjust d10 to be in the range 1-10
		d10 = mod(d10, 10) + 1

		print *, "Random D10: ", d10
