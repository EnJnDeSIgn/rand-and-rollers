module PowerSetModule_EnJnDeSIgn2024_DvVv82
    implicit none
contains
...
end module PowerSetModule_EnJnDeSIgn2024_DvVv82
program DvVv82_roller_EnJnDeSIgn2024
	! Turning this into a real program to adding rand selected and make more Quantum, Thank you Copilot!
	use PowerSetModule_EnJnDeSIgn2024_DvVv82
    implicit none
...
end program DvVv82_roller_EnJnDeSIgn2024