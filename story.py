...
sound_words = [
    ...
    "Tshk: the brittle snap of dry reeds breaking",
 	"Vesh: the soft sweep of wind over stone",
 	"Drun: the deep, hollow boom of a cavern echo",
 	"Frit: the tiny crackle of cooling pottery",
 	"Ghram: the low rumble of shifting earth",
 	"Slek: the wet slide of mud underfoot",
 	"Pthk: the muted thump of a sandbag landing",
 	"Whin: the thin whistle of distant wind",
 	"Krill: the faint clicking of insects in the dark",
 	"Zhur: the swirling hush of dust devils",
    "Meret: the shimmering resonance of water under moonlight",
 	"Khery: the soft scrape of sandals on temple floors",
 	"Sutem: the sudden hush before a storm breaks",
 	"Nemet: the muffled thud of ritual drums behind closed doors",
 	"Arket: the crackling glow of sacred fire offerings",
 	"Lunet: the crystalline chime of starlight on still water",
 	"Peru: the fluttering call of birds greeting dawn",
 	"Zahur: the radiant hum of sunlight warming stone",
 	"Tanen: the subterranean groan of the earth’s deep places",
 	"Sahket: the whisper of a priest drawing a curtain in the sanctuary",
    "Shirr: the gentle brushing of tall grass in a breeze",
 	"Gloop: the thick bubble of mud rising in a marsh",
 	"Tatter: the loose flap of cloth on a windy day",
 	"Rindle: the soft trickle of a narrow stream",
 	"Froth: the fizzing crest of a breaking wave",
 	"Skim: the faint scrape of a boat gliding over shallow water",
 	"Pip: the tiny peep of a hatchling bird",
 	"Rill: the crystalline run of water over smooth stones",
 	"Thrip: the quick flick of a lizard’s tail on sand",
 	"Murm: the low, blended hum of a crowded marketplace",
    "Vyre: the shimmering tone of magic gathering",
 	"Ethis: the soft pulse of a thought forming",
 	"Ruun: the resonant vibration of a name spoken with intention",
 	"Selen: the quiet glow of moonlit revelation",
 	"Khor: the deep, internal echo of memory awakening",
 	"Aesh: the breathlike sigh of a spell completing",
 	"Tirn: the crystalline ring of truth recognized",
 	"Vant: the hollow silence after something sacred departs",
 	"Orrin: the harmonic tremble of destiny aligning",
 	"Syth: the thin, silver whisper of intuition"
]
