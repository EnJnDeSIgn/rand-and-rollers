...
PLOT_POINTS = {
    ...
    "alien_crash": {
        "title": "Alien Crash",
        "description": "Fragments of an extraterrestrial spacecraft plummet to Earth, signaling a potential first contact event."
    },
    "undetectable_aliens": {
        "title": "Undetectable Exploration",
        "description": "Aliens are secretly exploring the Earth, remaining beyond human perception."
    },
    "accidental_destruction": {
        "title": "Prisoner of Accident",
        "description": "An alien is captured after inadvertently causing widespread destruction; they are plagued by guilt and remorse."
    },
    "depression_virus": {
        "title": "Targeted Virus",
        "description": "An engineered virus selectively eliminates individuals predisposed to depression, raising ethical and societal questions."
    },
    "clone_hunt": {
        "title": "Hunted by Self",
        "description": "A woman finds herself the target of a relentless pursuit by a clone created from her younger self."
    },
    "invisible_eruption": {
        "title": "The Silent Cataclysm",
        "description": "A massive volcanic eruption has occurred, blanketing the planet in ash, yet goes unnoticed – its source remains a mystery."
    },
    "ancient_skeleton": {
        "title": "Glacial Discovery",
        "description": "The melting of a glacier reveals the skeletal remains of a twelve-foot-tall humanoid, hinting at a forgotten past."
    },
    "magnetic_navigation": {
        "title": "Bio-Inspired Navigation",
        "description": "Scientists harness proteins from migratory birds and butterflies, which align with Earth’s magnetic field, for innovative navigational technology."
    },
    "myoglobin_adaptation": {
